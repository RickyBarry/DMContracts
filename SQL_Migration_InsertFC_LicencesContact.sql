...
/***	Where the FC_TYPE = Licences Contact						***/
...
SELECT	fst.OBJECTID,
  ...
  WHERE FC_TYPE = 'Licences Contact'    -- Just the Licenses Contact 
...
'sde.DEFAULT', 'mvInsert_LicensesContact', 1, 1, 'multiversioned view insert - Forest Internal Contact'

EXEC SDE.SDE.set_current_version 'mvInsert_LicensesContact'

EXEC SDE.SDE.edit_version 'mvInsert_LicensesContact', 1
...
EXEC SDE.SDE.edit_version 'mvInsert_LicensesContact', 2
