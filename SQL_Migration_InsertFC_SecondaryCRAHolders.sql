...
/***	Where the FC_TYPE = Secondary CRA Holder					***/
...
SELECT	fst.OBJECTID,
  ...
  WHERE FC_TYPE = 'Secondary CRA Holder'    -- Just the other company staff
...
'sde.DEFAULT', 'mvInsert_SecondaryCRAHolders', 1, 1, 'multiversioned view insert - Forest Internal Contact'

EXEC SDE.SDE.set_current_version 'mvInsert_SecondaryCRAHolders'

EXEC SDE.SDE.edit_version 'mvInsert_SecondaryCRAHolders', 1
...
EXEC SDE.SDE.edit_version 'mvInsert_SecondaryCRAHolders', 2
...
--  WHERE [FOREST_CONTACTS_ROLE] = 'SCRAH'
