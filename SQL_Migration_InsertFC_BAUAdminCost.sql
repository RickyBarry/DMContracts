...
/***	Where the FC_TYPE = BAU Admin and Cost Control				***/
/***	into TFM_CMN_FOREST_CONTACTS								***/
/***                                                                ***/
/***	Last modified												***/
/***                                                                ***/
/**********************************************************************/
...
SELECT	fst.OBJECTID,
  ...
  WHERE FC_TYPE = 'BAU Admin and Cost Control'    -- Just the BAU Admin and Cost Control
UPDATE #ForestContactsInternal 
	SET FC_HRID =  fcint.[HR_ID],
		FCRole	= fcint.[FC_ROLE]
...
'sde.DEFAULT', 'mvInsert_ForestBAUAdminCost', 1, 1, 'multiversioned view insert - Forest Internal Contact'

EXEC SDE.SDE.set_current_version 'mvInsert_ForestBAUAdminCost'

EXEC SDE.SDE.edit_version 'mvInsert_ForestBAUAdminCost', 1
...
EXEC SDE.SDE.edit_version 'mvInsert_ForestBAUAdminCost', 2
...
--  WHERE [FOREST_CONTACTS_ROLE] = 'BAUAC'
